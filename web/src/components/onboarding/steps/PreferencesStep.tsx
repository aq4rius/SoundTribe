...
export default function PreferencesStep({ goNext, goBack, onboarding, saveOnboarding }: { goNext: () => void; goBack: () => void; onboarding: any; saveOnboarding: (data: any) => void }) {
  ...
  useEffect(() => {
    getAllGenres().then((data) => {
      setGenreOptions(data.map((g: any) => g.name));
    });
  }, []);
