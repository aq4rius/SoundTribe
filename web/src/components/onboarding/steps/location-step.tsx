...
export default function LocationStep({ goNext, goBack, onboarding, saveOnboarding }: { goNext: () => void; goBack: () => void; onboarding: OnboardingState | null; saveOnboarding: (data: Partial<OnboardingState>) => void }) {
  ...
  const [willingToTravel, setWillingToTravel] = React.useState(onboarding?.locationDetails?.willingToTravel || 0);
