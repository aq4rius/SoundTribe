...
export default function SummaryStep({ goBack, onboarding, saveOnboarding }: { goBack: () => void; onboarding: OnboardingState | null; saveOnboarding: (data: Partial<OnboardingState>) => void }) {
