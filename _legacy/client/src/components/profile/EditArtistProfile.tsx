...
const EditArtistProfile: React.FC = () => {
  ...
  const [profile, setProfile] = useState<
    (ArtistProfile & { portfolioItems?: Array<{ isEditing?: boolean }> }) | null
  >(null);
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <input
        ...
        onChange={(e) => setProfile({ ...profile, instruments: e.target.value.split(', ') })}
      ...
      <div className="mt-4">
        ...
        <input
          ...
          onChange={(e) => {
            ...
            if (!currentDates.some((date) => date.toDateString() === newDate.toDateString())) {
              setProfile({
                ...profile,
                availability: {
      ...
      <input
        ...
        onChange={(e) => setProfile({ ...profile, ratePerHour: parseInt(e.target.value) })}
