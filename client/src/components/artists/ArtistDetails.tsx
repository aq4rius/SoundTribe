...
const ArtistDetails: React.FC = () => {
  ...
  console.log('artist.user:', artist.user);
    ...
    <div className="max-w-4xl mx-auto py-8 px-4">
      <div className="bg-base-100 rounded-lg shadow-lg p-6">
        ...
        <div className="mb-4 text-right">
          {user && typeof artist.user === 'string' && artist.user !== user.id && (
            <button
              ...
              onClick={() =>
                navigate(
                  `/chat?targetId=${
                    artist._id
                  }&targetType=ArtistProfile&targetName=${encodeURIComponent(artist.stageName)}`,
                )
              }
            >
              Send Message
            ...
            <section>
              ...
              <div className="flex gap-4">
                ...
                {artist.socialMediaLinks.twitter && (
                  <a
                    href={artist.socialMediaLinks.twitter}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="link link-primary"
                  >
                ...
                {artist.socialMediaLinks.youtube && (
                  <a
                    href={artist.socialMediaLinks.youtube}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="link link-primary"
                  >
